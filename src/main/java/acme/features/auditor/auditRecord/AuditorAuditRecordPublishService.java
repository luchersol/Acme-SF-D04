...
public class AuditorAuditRecordPublishService extends AbstractAntiSpamService<Auditor, AuditRecord> {
	...
	public void perform(final AuditRecord object) {
		...
		List<Mark> mark = this.repository.findCodeAuditMark(object.getCodeAudit().getId());
		CodeAudit codeAudit = this.repository.findCodeAuditById(object.getCodeAudit().getId());
		codeAudit.setMark(mark.get(0));
